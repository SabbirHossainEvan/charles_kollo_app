...
//               activeOpacity={0.8}
//               className="w-full bg-[#1C1C1E] h-16 rounded-2xl px-5 flex-row items-center justify-between border border-white/10"
//             >
...
//                   className="rounded-3xl border border-[#232323]"
...
//                         Keyboard.dismiss();
//                       }}
//                       className="flex-row items-center bg-[#232323] px-4 rounded py-6 border-b border-white/5"
//                     >
//                       <Image
//                         source={{ uri: item.flag }}
//                         className="w-8 h-5 rounded-sm mr-4"
//                       />
//                       <Text className="text-lg text-white/90 flex-1">
//                         {item.name}
//                       </Text>
//                       {selectedCountry.id === item.id && (
//                         <View className="w-2 h-2 rounded-full bg-[#c5a35d]" />
//                       )}
//                     </TouchableOpacity>
//                   )}
//                 />
